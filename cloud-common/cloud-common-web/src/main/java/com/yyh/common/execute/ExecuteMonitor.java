...
public class ExecuteMonitor extends ThreadPoolExecutor {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        logger.info(String.format(poolName + "-pool-monitor: PoolSize: %d, CorePoolSize: %d, Active: %d, Completed: %d, Task: %d, Queue: %d, LargestPoolSize: %d, MaximumPoolSize: %d,  KeepAliveTime: %d, isShutdown: %s, isTerminated: %s",
